...
function NavLink({ href, children, isActive, ...rest }: NavLinkProps) {
  ...
  const MdOutlineMenu = '/static/svg/urbanikMenu.svg'
  ...
  (props: IconButtonProps, ref: React.Ref<any>) => {
    return (      
      <IconButton
        ...
        fontSize="20px"        
        icon={<MenuUrbanik color='black' w='25px'/>}
        {...props}
...
const MenuUrbanik = (props) => (
  <Icon viewBox="0 0 30 15" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g id="Group 48097077">
